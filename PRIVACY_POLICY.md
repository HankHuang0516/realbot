...
*   **Device ID (裝置識別碼)**：用於區分不同裝置，確保您的桌布能正確連線。
...
*   **Device ID**: Used to distinguish different devices to ensure your wallpaper connects correctly.
...
*   ❌ Your GPS location
*   ❌ Your camera or microphone data
