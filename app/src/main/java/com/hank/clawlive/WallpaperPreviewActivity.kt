...
class WallpaperPreviewActivity : AppCompatActivity() {
    ...
    private fun setupListeners() {
        ...
        switchBackground.setOnCheckedChangeListener { _, isChecked ->
            ...
            if (!isChecked) {
                Toast.makeText(this, "Background disabled", Toast.LENGTH_SHORT).show()
            }
        }
    }
    ...
    private fun openPhotoPicker() {
        try {
            ...
            Toast.makeText(this, "Cannot open photo picker", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun openWallpaperChooser() {
        try {
            ...
            Toast.makeText(this, "Cannot open wallpaper settings", Toast.LENGTH_SHORT).show()
        }
    }
