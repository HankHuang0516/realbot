...
```
backend/
├── data/                        # NEW: Data persistence directory
│   ├── .gitkeep                # Ensures directory is tracked in git
│   └── devices.json            # Runtime data (ignored by git)
├── index.js                     # MODIFIED: Added validation + persistence
├── stress-test.js              # NEW: Comprehensive stress tests
├── test-persistence.js         # NEW: Redeployment persistence tests
├── TEST-README.md              # NEW: Testing documentation
├── package.json                # MODIFIED: Added test scripts
└── .gitignore                  # MODIFIED: Added data/* and test files
```
...
2. ⬜ Railway Volume configured (`/app/backend/data`)
3. ⬜ Push to Railway
4. ⬜ Wait for deployment
5. ⬜ Run production tests: `npm run test:production`
6. ⬜ Verify existing entities still bound
7. ⬜ Monitor logs for persistence messages
